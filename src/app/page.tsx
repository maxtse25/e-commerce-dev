        ...
        <div className="col-span-2 px-6 lg:px-0 lg-pt-4">
          ...
          flex flex-col items-center lg:items-start">
            ...
            !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
              Your Image on a <span className="bg-green-600 px-2 
              text-white">Custom</span> Phone Case</h1>
              ...
              sm:items-start gap-5">
                <div className="flex -space-x-4">
                  ...
                  alt="user image"
                  />
                  <img className="inline-block object-cover h-10 w-10 
                  rounded-full ring-2 ring-slate-100" src='users/user-5.jpg'
                  alt="user image"
                  />
                </div>
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              <div className="flex gap-0.5 mb-2">
                <StarIcon className='h-5 w-5 text-green-600 fill-green-600' />
                <StarIcon className='h-5 w-5 text-green-600 fill-green-600' />
                <StarIcon className='h-5 w-5 text-green-600 fill-green-600' />
                <StarIcon className='h-5 w-5 text-green-600 fill-green-600' />
                <StarIcon className='h-5 w-5 text-green-600 fill-green-600' />
              ...
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <CheckIcon className="h-4 w-4 stroke-[3px] text-green-600"></CheckIcon>
      ...
      <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              <img src="/arrow.png" className="absolute top-[25rem] md:top-1/2-transalte-y-1/2 z-10 left-1/2 -transalte-x1/2 rotate-90 md:rotate-0" />

              <div className="relative h-80 md:h-full w-full md:justify-self-and max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
          ...
          <ul className='mx-auto mt-12 max0w0orise sm:text-lg space-y-2 w-fit'>
            <li className="w-fit">
            ...
            <li className="w-fit">
              <CheckIcon className='h-5 w-5 text-green-600 inline mr-1.5' />
              Scratch and fingerprint sresistant coating
            </li>
            <li className="w-fit">
              <CheckIcon className='h-5 w-5 text-green-600 inline mr-1.5' />
            ...
            <Link
                ...
                Create your case now <ArrowRightIcon className='h-4 w-4 ml-1.5' />
              </Link>
            </div>
          </ul>
      </MaxWidthWrapper>
