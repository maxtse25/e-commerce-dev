...
const DesignConfigurator = ({
    ...
    // Function to convert base64 to an actual PNG
    ...
    return <div className="relative mt-20 grid grid-cols-1 lg:grid-col-3 mb-20 pb-20">
                <div 
                    ref={containerRef}
                        ...
                        <div className="relative mt-4 h-full flex flex-col justify-between"> 
                            <div className="flex flex-col gap-6">
                                ...
                                onChange={(val) => {
                                    ...
                                    <Listbox>Color: {options.color.label}</Listbox>
